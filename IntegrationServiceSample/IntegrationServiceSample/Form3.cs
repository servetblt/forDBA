...
namespace IntegrationService
{
    ...
    public partial class Form3 : MetroFramework.Forms.MetroForm
    {
        ...
        private void getServer()
        {
            ...
            {
                MessageBox.Show("Server Bilgisi Alınamadı");
            }
        }
            ...
            else if (Convert.ToInt32(selectedIndex) == 1)
            {
                for (int i = 0; i <= dataGridView1.Rows.Count; i++)
                {
                    try
                    {
                        ...
                        DateTime date1 = Convert.ToDateTime(dataGridView1.Rows[i].Cells[13].Value.ToString());
                        DateTime date2 = Convert.ToDateTime(dataGridView1.Rows[i].Cells[14].Value.ToString());
 ...
 insert into [dbo].[tblUserInformation] values(
	...
	@Permissions_user,
      GETDATE() )", con);
                        ...
                        cmd.Parameters.AddWithValue("@dbname", dataGridView1.Rows[i].Cells[1].Value);
                        cmd.Parameters.AddWithValue("@dbUser", Convert.ToString(dataGridView1.Rows[i].Cells[2].Value));
                        cmd.Parameters.AddWithValue("@serverLogin", dataGridView1.Rows[i].Cells[3].Value);
                        cmd.Parameters.AddWithValue("@logintype", dataGridView1.Rows[i].Cells[4].Value);
                        cmd.Parameters.AddWithValue("@sysadmin", dataGridView1.Rows[i].Cells[5].Value);
                        cmd.Parameters.AddWithValue("@securityadmin", dataGridView1.Rows[i].Cells[6].Value);
                        cmd.Parameters.AddWithValue("@serveradmin", dataGridView1.Rows[i].Cells[7].Value);
                        cmd.Parameters.AddWithValue("@diskadmin", dataGridView1.Rows[i].Cells[8].Value);
                        cmd.Parameters.AddWithValue("@setupadmin", dataGridView1.Rows[i].Cells[9].Value);
                        cmd.Parameters.AddWithValue("@processadmin", dataGridView1.Rows[i].Cells[10].Value);
                        cmd.Parameters.AddWithValue("@dbcreator", dataGridView1.Rows[i].Cells[11].Value);
                        cmd.Parameters.AddWithValue("@bulkadmin", dataGridView1.Rows[i].Cells[12].Value);
                        cmd.Parameters.AddWithValue("@create_date", sqlFormattedDate1);
                        cmd.Parameters.AddWithValue("@modify_date", sqlFormattedDate2);
                        cmd.Parameters.AddWithValue("@Permissions_user", Convert.ToString(dataGridView1.Rows[i].Cells[15].Value));
            ...
            else if (Convert.ToInt32(selectedIndex) == 2)
            {
                for (int i = 0; i <= dataGridView1.Rows.Count; i++)
                {
                    try
                    {
                        ...
                        DateTime date1 = Convert.ToDateTime(dataGridView1.Rows[i].Cells[2].Value.ToString());
                        DateTime date2 = Convert.ToDateTime(dataGridView1.Rows[i].Cells[3].Value.ToString());
                        DateTime date3 = Convert.ToDateTime(dataGridView1.Rows[i].Cells[13].Value.ToString());
...
insert into tblBackupInfoNews values( 	
      ...
      GETDATE() )", con);
                        ...
                        cmd.Parameters.AddWithValue("@DatabaseName", dataGridView1.Rows[i].Cells[1].Value);
                        cmd.Parameters.AddWithValue("@LastFullBackup", sqlFormattedDate1);
                        cmd.Parameters.AddWithValue("@LastDiffBackup", sqlFormattedDate2);
                        cmd.Parameters.AddWithValue("@LastBackup_Hrs", Convert.ToInt32(dataGridView1.Rows[i].Cells[4].Value));
                        cmd.Parameters.AddWithValue("@dbstatus", dataGridView1.Rows[i].Cells[5].Value);
                        cmd.Parameters.AddWithValue("@dbsize", dataGridView1.Rows[i].Cells[6].Value);
                        cmd.Parameters.AddWithValue("@dbbackupsize", dataGridView1.Rows[i].Cells[7].Value);
                        cmd.Parameters.AddWithValue("@dbbackuptime", dataGridView1.Rows[i].Cells[8].Value);
                        cmd.Parameters.AddWithValue("@dbcompretionRate", dataGridView1.Rows[i].Cells[9].Value);

                        cmd.Parameters.AddWithValue("@dbInPerSec", dataGridView1.Rows[i].Cells[10].Value);
                        cmd.Parameters.AddWithValue("@dbOutPerSec", dataGridView1.Rows[i].Cells[11].Value);

                        cmd.Parameters.AddWithValue("@BackupStatus", dataGridView1.Rows[i].Cells[12].Value);
                        cmd.Parameters.AddWithValue("@lastTlogBackup", sqlFormattedDate3);
                        cmd.Parameters.AddWithValue("@RecoveryModel", dataGridView1.Rows[i].Cells[14].Value);
                        cmd.Parameters.AddWithValue("@NoTLogSince", Convert.ToInt32(dataGridView1.Rows[i].Cells[15].Value));
                        cmd.Parameters.AddWithValue("@TlogBkpStatus", dataGridView1.Rows[i].Cells[16].Value);
            ...
            else if (Convert.ToInt32(selectedIndex) == 3)
            {
                ...
                for (int i = 0; i <= dataGridView1.Rows.Count; i++)
                {
                    try
                    {
                        ...
                        cmd.Parameters.AddWithValue("@sql_version", dataGridView1.Rows[i].Cells[1].Value);
                        cmd.Parameters.AddWithValue("@sql_edition", dataGridView1.Rows[i].Cells[2].Value);
                        cmd.Parameters.AddWithValue("@service_pack_level", dataGridView1.Rows[i].Cells[3].Value);
                        //   cmd.Parameters.AddWithValue("@build_number", Convert.ToInt32(dataGridView1.Rows[i].Cells[4].Value));
                        cmd.Parameters.AddWithValue("@build_number", dataGridView1.Rows[i].Cells[4].Value);

                        cmd.Parameters.AddWithValue("@port_number", dataGridView1.Rows[i].Cells[5].Value);
                        cmd.Parameters.AddWithValue("@min_server_memory", dataGridView1.Rows[i].Cells[6].Value);
                        cmd.Parameters.AddWithValue("@max_server_memory", dataGridView1.Rows[i].Cells[7].Value);
                        cmd.Parameters.AddWithValue("@server_memory", dataGridView1.Rows[i].Cells[8].Value);
                        cmd.Parameters.AddWithValue("@server_core", dataGridView1.Rows[i].Cells[9].Value);

                        cmd.Parameters.AddWithValue("@sql_core", dataGridView1.Rows[i].Cells[10].Value);
                        cmd.Parameters.AddWithValue("@max_dop", dataGridView1.Rows[i].Cells[11].Value);

                        cmd.Parameters.AddWithValue("@cost_threshould_for_paralelism", dataGridView1.Rows[i].Cells[12].Value);
...
,user1.dbname,username dbUser ,CAST(ISNULL(SL.name,'') AS nvarchar) AS serverLogin,logintype,CAST(ISNULL(sysadmin,'') AS nvarchar)sysadmin
,CAST(ISNULL(securityadmin,'')AS nvarchar)securityadmin,CAST(ISNULL(serveradmin,'')AS nvarchar)serveradmin,CAST(Isnull(diskadmin,'')AS nvarchar)diskadmin
,CAST(ISNULL(setupadmin,'')AS nvarchar)setupadmin,CAST(ISNULL(processadmin,'')AS nvarchar)processadmin,CAST(ISNULL(dbcreator,'')AS nvarchar)dbcreator
,CAST(ISNULL(bulkadmin,'')AS nvarchar)bulkadmin,user1.create_date ,user1.modify_date
,STUFF(
(
...
,1,1,'') AS Permissions_user,GETDATE() as logTime
FROM @DB_USers user1
