...
,CONNECTIONPROPERTY('local_net_address') ServerIP
,CONNECTIONPROPERTY('local_tcp_port') ServerPort
...
SELECT 
   ...
   cast( CONNECTIONPROPERTY('local_net_address')as nvarchar(100)) ServerIP,
   cast( CONNECTIONPROPERTY('local_tcp_port')as nvarchar(100)) ServerPort,
   cast(v.sql_version as nvarchar(100)) sql_version,
