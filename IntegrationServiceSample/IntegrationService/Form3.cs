    ...
    public partial class Form3 : MetroFramework.Forms.MetroForm
    {
        ...
        private void getServer()
        {
            try
            {
                ...
                SqlDataAdapter da = new SqlDataAdapter(@"select "+columnName+",domain from "+tableName+" ", con);
        ...
        private void getData()
        {
            this.Hide();   
                ...
                try
                {
                    domain = dataGridView2.Rows[i].Cells[1].Value.ToString();
                    ...
                    if (domain=="vftr") {
                        ...
                        SqlConnection con = new SqlConnection("server=" + serverName2 + "; Initial Catalog=master;Integrated Security=SSPI; CONNECT TIMEOUT=150");
                    ...
                    else
                    {
                        ...
                        SqlConnection con = new SqlConnection("server=" + serverName2 + "; Initial Catalog=master;User Id=sqlmngmt;Password=DBxjaPXbw3b+yh5s;CONNECT TIMEOUT=150");
                        SqlDataAdapter da = new SqlDataAdapter(@"" + query + "", con);
                        DataSet ds = new DataSet();
                        con.Open();
                        da.Fill(ds, "query");
            ...
            if (Convert.ToInt32(selectedIndex) == 0)
            {
                ...
                for (int i = 0; i <= dataGridView1.Rows.Count; i++)
                {
                    ...
                    try
                    {
                        ...
                        SqlConnection con = new SqlConnection(@"server=" + serverName + "; Initial Catalog=" + databaseName + ";Integrated Security=SSPI; CONNECT TIMEOUT=5");
            ...
            else if (Convert.ToInt32(selectedIndex) == 2)
            {
                for (int i = 0; i <= dataGridView1.Rows.Count; i++)
                {
                    try
                    {
                        ...
                        SqlConnection con = new SqlConnection(@"server = " + serverName + "; Initial Catalog = " + databaseName + "; Integrated Security = SSPI; CONNECT TIMEOUT=150");
                        SqlCommand cmd = new SqlCommand(@"
